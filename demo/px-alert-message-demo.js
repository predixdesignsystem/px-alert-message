...
import '../px-alert-message.js';
import { Polymer } from '@polymer/polymer/lib/legacy/polymer-fn.js';
import { html } from '@polymer/polymer/lib/utils/html-tag.js';
Polymer({
  _template: html`
    <!-- Header -->
    <px-demo-header module-name="px-alert-message" description="Alert Messages appear in a queue within the message container. Each message consists of an icon, title,
          ...
          text on the alert messages should be kept short, ideally around three lines." tablet="" desktop="">
    </px-demo-header>
    ...
    <px-demo-interactive>
      ...
      <px-demo-component slot="px-demo-component">
          ...
          <px-alert-message visible="{{props.visible.value}}" type="{{props.type.value}}" message-title="{{props.messageTitle.value}}" message="{{props.message.value}}" auto-dismiss="{{props.autoDismiss.value}}" action="{{props.action.value}}" hide-severity="{{props.hideSeverity.value}}" hide-badge="{{props.hideBadge.value}}">
          </px-alert-message>
      ...
      <px-demo-component-snippet slot="px-demo-component-snippet" element-properties="{{props}}" element-name="px-alert-message">
